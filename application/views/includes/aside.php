        ...
        <div class="menubar-scroll-inner">
            <ul class="app-menu">
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        <li><a href="#"><i class="menu-icon fa fa-photo"></i><span class="menu-text">Resim Galerisi</span></a></li>
                        <li><a href="#"><i class="menu-icon fa fa-video-camera"></i><span class="menu-text">Video Galerisi</span></a></li>
                        <li><a href="#"><i class="menu-icon fa fa-file"></i><span class="menu-text">Dosya Galerisi</span></a></li>
                    </ul>
                </li>
